...
function VideoPlayer () {
    ...
    useEffect(() => {
        ...
        setIsLoading(true);
        axios
            .get(`https://www.googleapis.com/youtube/v3/videos?part=snippet%2C%20statistics&id=${videoId}&key=AIzaSyCBwn4KniBP7F4NChmYTSdrkfDxKSWZoDE`)
            .then(response => {
    ...
    async function createVideoInfo(video) {
        ...
        const response = await axios
            .get(`https://www.googleapis.com/youtube/v3/channels?part=snippet%2C%20statistics&id=${channelId}&key=AIzaSyCBwn4KniBP7F4NChmYTSdrkfDxKSWZoDE`)
