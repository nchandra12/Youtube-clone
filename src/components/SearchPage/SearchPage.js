...
function SearchPage(props) {
    ...
    useEffect(() => {
        ...
        setVideoRows([]);
        axios
            .get(`https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=1&type=channel&q=${searchQuery}&safeSearch=none&key=AIzaSyCBwn4KniBP7F4NChmYTSdrkfDxKSWZoDE`)
            .then(response => {
        ...
        axios
            .get(`https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=9&type=video&q=${searchQuery}&safeSearch=none&key=AIzaSyCBwn4KniBP7F4NChmYTSdrkfDxKSWZoDE`)
            .then(response => {
    ...
    async function createChannelRow(channel) {
        ...
        const response = await axios
            .get(`https://www.googleapis.com/youtube/v3/channels?part=statistics&id=${channelId}&key=AIzaSyCBwn4KniBP7F4NChmYTSdrkfDxKSWZoDE`)
    ...
    async function createVideoRows(videos) {
        ...
        for (const video of videos) {
            ...
            const response = await axios
                .get(`https://www.googleapis.com/youtube/v3/videos?part=statistics%2C%20snippet&id=${videoId}&key=AIzaSyCBwn4KniBP7F4NChmYTSdrkfDxKSWZoDE`)
